...
public class Client {
	...
	private static String serviceURL = "http://sdk2.zucp.net:8060/webservice.asmx";

	//private static String sn = "SDK-BBX-010-15672";// 序列号
	private static String sn = "";// 序列号
	private static String password = "880124";// 密码
	...
	public String myMo() throws UnsupportedEncodingException{
		String uu = this.mo() ;
		if(uu!=null){
			return java.net.URLDecoder.decode(uu,"gb2312"); 
		}
		return uu ; 
	}
	...
	public String mdSmsSend_u(String mobile, String content, String ext, String stime,
		...
		try {
			...
			log.debug("报错异常短信参数"+sn+"  "+pwd+"  "+mobile+"====内容:"+content) ;
			e.printStackTrace();
			//如果报异常  则返回-10
			return "-10";
		}
