package com.bskcare.ch.mail.util;
/** 
* 发送邮件需要使用的基本信息 
*/ 
...
public class MailSenderInfo { 
	...
	// 邮件发送者的地址 
	private String fromAddress = "admin@bskcare.com"; 
	// 邮件接收者的地址 
	private String toAddress; 
	// 登陆邮件发送服务器的用户名和密码 
	private String userName = "admin@bskcare.com"; 
	private String password = "bskcare_36524"; 
	// 是否需要身份验证 
