...
public class ModulePicker5 extends AbstractObjectPicker{
	...
	public TgMeals picker(PickerCondition pc) {
		...
		if(pc != null){
			...
			List<String> lstZhushi = foodQuantity.getZhushi(pc, 5, lstCookedFood);
			if(!CollectionUtils.isEmpty(lstZhushi)&&lstZhushi.size()==3){
				...
				String zaocanOther = foodQuantity.getZaocanOther(pc, 5, lstCookedFood);
				...
				String wucanOther = foodQuantity.getWucanOther(pc, zaocan, 5, lstCookedFood);
