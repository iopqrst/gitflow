...
public class MessageFlow {
	...
	private int sendMode; // 发送方式 默认0为激光推送，1短信发送
	...
	public String toString() {
		return "MessageFlow [id=" + id + ", clientType=" + clientType
				+ ", bazzaarGrade=" + bazzaarGrade + ", intervals=" + intervals
				+ ", cycle=" + cycle + ", iscycle=" + iscycle + ", taskTitle="
				+ taskTitle + ", particulars=" + particulars + ", sendMode="
				+ sendMode + "]";
	}
