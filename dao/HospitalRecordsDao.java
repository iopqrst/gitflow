...
public interface HospitalRecordsDao extends BaseDao<HospitalRecords>{
	/**
	 * 住院扩展类集合
	 * @param clientId
	 * @return
	 ...
	 * 住院记录集合分页
	 */
	public PageObject<HospitalRecordsExtend> messagelist(Integer clientId,QueryInfo info);
