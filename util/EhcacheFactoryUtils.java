...
public class EhcacheFactoryUtils {
	...
	public static final String CACHE_NAME_CLIENT_VALIDTOR = "ClientInfoCaching";// 用户信息缓存
	public static final String CACHE_NAME_TIMELINE_CONTENT = "TimelineContentCaching"; //用户时间轴内容缓存
